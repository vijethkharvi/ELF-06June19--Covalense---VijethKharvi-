...
public final class JdbcProgramForAWSDB {
	public static void main(String[] args) {
		...
		String dbUrl = "jdbc:mysql://pablomysql.c8qqpvokgmrh.ap-south-1.rds.amazonaws.com:3306/vijeth";
		
		JdbcProgramForAWSDB ref = new JdbcProgramForAWSDB();
		 ...
		 * 
		 */
		try (Connection con =DriverManager.getConnection(dbUrl, "root", "Viju11429");
