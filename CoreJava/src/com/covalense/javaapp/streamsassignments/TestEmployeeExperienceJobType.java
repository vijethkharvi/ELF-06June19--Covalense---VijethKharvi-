...
@Log
public class TestEmployeeExperienceJobType {
	...
	public static void main(String[] args) {
		...
		List<Employee> list = al.stream().filter(i -> (i.getExperience() > 2&&i.getDesignation()=="Software Engineer")).collect(Collectors.toList());
